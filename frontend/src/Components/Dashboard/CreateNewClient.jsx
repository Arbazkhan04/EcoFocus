    ...
    return (
        <div className="p-6 bg-gray-100 min-h-screen">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white flex flex-col justify-between p-4 rounded shadow-md">
                ...
                {/* Remove Agency */}
                <div className="bg-white flex flex-col justify-between p-4 rounded shadow-md col-span-2 lg:col-span-1">
                ...
                <div className="bg-white flex flex-col justify-between p-4 rounded shadow-md col-span-2 lg:col-span-1">
                    ...
                    <button className="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600 w-full">Delete Data</button>
                </div>
            </div>
        </div>
    );
